...
def all_grades_data_fetcher(s_all_grade_html_content : str) -> tuple[int, list[dict]]:
    ...
    x_xpath_dates_path =              dom.xpath("/html/body/div[1]/div[4]/div[2]/div/div[@class='flex-table row']/div[1]")
    x_xpath_notes_path =              dom.xpath("/html/body/div[1]/div[4]/div[2]/div/div[@class='flex-table row']/div[2]")
    x_xpath_note_grading_types_path = dom.xpath("/html/body/div[1]/div[4]/div[2]/div/div[@class='flex-table row']/div[3]")
    x_xpath_note_grades_path =        dom.xpath("/html/body/div[1]/div[4]/div[2]/div/div[@class='flex-table row']/div[4]")
